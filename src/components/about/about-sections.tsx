        ...
        <div className="relative overflow-hidden rounded-[16px]">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center px-4 text-center text-white sm:px-8">
            ...
            <p className="banner-desc mt-3 max-w-5xl text-white/90">
              <TranslatedText
                text="A aim to bridge the gap between families and quality care providers, making it simple to discover, compare, and connect with the right residential options for your loved ones."
          ...
          <div className="grid grid-cols-1 gap-5 sm:grid-cols-2">
            <div className="relative row-span-2 overflow-hidden rounded-xl">
              <Image
                ...
                width={760}
                height={600}
                className="h-[260px] w-full object-cover sm:h-[410px]"
              />
            </div>
      ...
      <section className="container mx-auto px-4 sm:px-6 lg:px-10">
        ...
        <div className="mt-10 grid items-start gap-8 lg:grid-cols-[1fr_1fr]">
          ...
          <div className="space-y-4">
            <p className="section-desc text-slate-600">
              <TranslatedText
                text="The idea for 0211wohnen was born from a simple observation - people searching for furnished apartments often face unnecessary complexity, unclear pricing, and too many intermediaries. High quality, professionally managed apartments are frequently difficult to find in one trusted place, while renters struggle to compare options and landlords lack a clear way to present their properties. We saw the need for a platform that removes the confusion, gives renters full visibility, and allows properties to be showcased directly and honestly without unnecessary middlemen."
                cacheKey="about:section3:body1"
              />
            </p>
            <p className="section-desc text-slate-600">
              <TranslatedText
                text="Our vision is to create a dependable, easy to use space where tenants and landlords can connect with confidence. By combining intuitive search tools, clear property information, and direct communication, we aim to make the rental process faster, smoother, and more transparent. 0211wohnen is more than a listing website - it is a platform designed to connect people with the right homes in the right location, with clarity and trust at every step."
                cacheKey="about:section3:body2"
              />
            </p>
          </div>
        </div>
